...
def apply_static_sso_admin(
    ...
    """Promote configured Microsoft emails to admin with SSO enabled."""
...
def get_or_create_user_from_sso(
    ...
    if auto_create:
        ...
        user = UserProfile(
            ...
            sso_enabled=True,
            role="admin" if is_static_sso_admin(microsoft_user.email) else settings.sso_default_role,
            scope_type="management" if is_static_sso_admin(microsoft_user.email) else settings.sso_default_scope_type,
            scope_value="all" if is_static_sso_admin(microsoft_user.email) else settings.sso_default_scope_value,
